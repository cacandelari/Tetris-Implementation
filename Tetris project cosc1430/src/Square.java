...
public class Square {
    ...
    protected boolean rotationCheck;
    ...
    public void setRotationCheck(boolean x){
        rotationCheck = x;
    }
    public boolean getRotationCheck(){
        return rotationCheck;
    }

    /**
    *Changing Row and Column values for rotation
    */
    ...
    public boolean canMove(Direction direction) {
        ...
        switch (direction) {
            ...
            case RIGHT:
                ...
                if (col == 9 || grid.isSet(row, col +1)) //************check this line***********//
                    move=false;
                break;
        }
        return move;

    ...
    public int checkRows() {
        ...
        for (row = 0; row< HEIGHT; row++) {
            ...
            if(col == WIDTH) // a row is found
            {
                ...
                //System.out.println("Score: " + Score + " " + "Counter: " + counter);
                return Score;
            }
        }
        Score = 0;
        //Score = Score + (100 * counter);
        //This all works as intended. 100 points for each row removed.
        //System.out.println("CheckRows Score: " + Score);
        return 0;
    }
